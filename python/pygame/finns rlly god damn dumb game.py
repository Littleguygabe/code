...
player1 = pygame.Rect(screen_width/3 - 10, screen_height/2 - 10, 20, 20)
player2 = pygame.Rect((screen_width/3)*2 - 10, screen_height/2 - 10, 20, 20)
...
textRect1.center = (screen_width/3, screen_height/2 - 30)
...
while True:
    ...
    for i in range (0,len(player1_path),2):
        ...
        pygame.draw.rect(screen, RED, player1_line)
        
    for i in range (0,len(player2_path),2):
        player2_line = pygame.Rect(player2_path[i]-2.5,player2_path[i+1]-2.5, 5, 5)
        pygame.draw.rect(screen, BLUE, player2_line)

    pygame.draw.ellipse(screen, RED, player1)
    pygame.draw.ellipse(screen, BLUE, player2)
    ...
    if player1_win == True:
        label = font_bigger.render("Player 1 wins!", 1, RED)
