                ...
                try:
                    ...
                    for P in self.__AllowedPatterns:
                        ...
                        if P.MatchesPattern(PatternString, CurrentSymbol): #passes in a 9 element long array that contains the pattern of a 3x3 grid
                            ...
                            ###
                            self.__GetCell(StartRow, StartColumn).setPartOfPattern() #top left
                            self.__GetCell(StartRow, StartColumn + 1).setPartOfPattern() #top center
                            self.__GetCell(StartRow, StartColumn + 2).setPartOfPattern() #top right
                            self.__GetCell(StartRow - 1, StartColumn + 2).setPartOfPattern() #right center
                            self.__GetCell(StartRow - 2, StartColumn + 2).setPartOfPattern() #bottom right
                            self.__GetCell(StartRow - 2, StartColumn + 1).setPartOfPattern() #bottom center
                            self.__GetCell(StartRow - 2, StartColumn).setPartOfPattern() #bottom left
                            self.__GetCell(StartRow - 1, StartColumn).setPartOfPattern() #left center
                            self.__GetCell(StartRow - 1, StartColumn + 1).setPartOfPattern() #center center
...
class Cell():
    ...
    def setPartOfPattern(self):
        self.partOfPattern = True
    
    def unsetPartOfPattern(self):
        self.partOfPattern = False
    
    def checkPartofPattern(self):
        return self.partOfPattern
