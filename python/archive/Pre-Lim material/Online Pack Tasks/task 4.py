    ...
    def __init__(self, *args):
        if len(args) == 1:
            ...
            for symbol in self.__AllowedSymbols:
                self.PatternCount[symbol] = random.randint(1,3)
            print(f'Pattern count: {self.PatternCount}')
            ### End of Changes
                ...
                try:
                    ...
                    for P in self.__AllowedPatterns:
                        ...
                        if P.MatchesPattern(PatternString, CurrentSymbol): #passes in a 9 element long array that contains the pattern of a 3x3 grid
                            ...
                            ### Changes
                            print(f'Pattern count: {self.PatternCount}')
                            if self.PatternCount[CurrentSymbol]<=0:
                                print(f'Pattern count: {self.PatternCount}')
                                return 0
                            
                            self.PatternCount[CurrentSymbol]-=1
                            print(f'Pattern count: {self.PatternCount}')
                            return 10
