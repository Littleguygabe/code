                    ...
                    for P in self.__AllowedPatterns:
                        ...
                        if P.MatchesPattern(PatternString, CurrentSymbol): #passes in a 9 element long array that contains the pattern of a 3x3 grid
                            for C in PatternList:
                                time.sleep(2)
                                print('Working in C')
                                #ensures that the symbol is not previously blocked by using '@' and then also checks 'checksymbolallowed'
                                #and flips the value so if the symbol isn't allowed then the if statement is run
