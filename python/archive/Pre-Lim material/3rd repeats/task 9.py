    ...
    def __init__(self, *args):
        if len(args) == 1:
            ...
            for i in range(5):
                ...
                while self.__Grid[Index].GetSymbol() != '-':
                    Index = random.randint(0,len(self.__Grid)-1)
    ...
    def CheckforMatchWithPattern(self, Row, Column):
        for StartRow in range(Row + 2, Row - 1, -1):
            for StartColumn in range(Column - 2, Column + 1):
                try:
                    Patternarr = []
                    Patternarr.append(self.__GetCell(StartRow, StartColumn))
                    Patternarr.append(self.__GetCell(StartRow, StartColumn + 1))
                    Patternarr.append(self.__GetCell(StartRow, StartColumn + 2))
                    Patternarr.append(self.__GetCell(StartRow - 1, StartColumn + 2))
                    Patternarr.append(self.__GetCell(StartRow - 2, StartColumn + 2))
                    Patternarr.append(self.__GetCell(StartRow - 2, StartColumn + 1))
                    Patternarr.append(self.__GetCell(StartRow - 2, StartColumn))
                    Patternarr.append(self.__GetCell(StartRow - 1, StartColumn))
                    Patternarr.append(self.__GetCell(StartRow - 1, StartColumn + 1))
