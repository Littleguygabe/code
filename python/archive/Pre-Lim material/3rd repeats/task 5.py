...
class Puzzle():
    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            choice = input('Do you want to remove a cell? Y/N')[0].upper()
            if choice == 'Y':
                RS = True
            else:
                RS = False
            ...
            if RS:
                ...
                if CurrentCell.GetSymbol() !='-' and CurrentCell.GetSymbol() !='@' and CurrentCell.CheckSymbolAllowed(CurrentCell.GetSymbol()):
                    self.__Grid[(self.__GridSize - Row) * self.__GridSize + Column - 1] = Cell()
                    self.__SymbolsLeft+=1
                else:
                    print('Cannot delete that cell')
            else:
