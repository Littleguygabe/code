    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            if self.lever and not self.leverUsed:
                choice = input('Do you want to use your lever? y/n').lower()
                if choice == 'y':
                    self.UsingLever = True
            ...
            ###
            if self.UsingLever:
                if self.__Grid[(self.__GridSize - Row) * self.__GridSize + Column - 1].GetSymbol() == '@':
                    self.__Grid[(self.__GridSize - Row) * self.__GridSize + Column - 1] = Cell()
                    self.leverUsed = True
                else:
                    print('That is not a blocked cell')
            ###
