...
class Puzzle():
    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            if CurrentCell.CheckSymbolAllowed(Symbol) and not CurrentCell.checkPartOfPattern():
                ...
                print('Cannot place there as the symbol is part of a 3x3 pattern or is blocked')
...
### 
    def checkValid(self,val):
        if val>self.__GridSize or val<1:
            print('Input outside of grid range')
            return False
        return True
...
class Cell():
    ...
    def AddToNotAllowedSymbols(self, SymbolToAdd):
        ...
        ##
        if SymbolToAdd == self._Symbol and SymbolToAdd!='':
