...
class Puzzle():
    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            ##
            print(f'You have {self.NwildCards} wild cards left to use')
            ...
            if CurrentCell.CheckSymbolAllowed(Symbol):
                #
                if not CurrentCell.CheckSymbolAllowed(CurrentCell.GetSymbol()) and self.NwildCards>0:
                    self.__Grid[(self.__GridSize - Row) * self.__GridSize + Column - 1] = wildCardCell()
                    self.NwildCards-=1
                else:
                    ###
                    if self.NwildCards<=0:
                        print('Cannot place there - no wild cards left')
                ...
                try:
                    ...
                    for P in self.__AllowedPatterns:
                        ...
                        for symbol in PatternString:
                            if symbol == 'W':
                                PatternString2+=CurrentSymbol
                                symbolscore = 15
                            else:
                                PatternString2+=symbol


                        if P.MatchesPattern(PatternString2, CurrentSymbol): #passes in a 9 element long array that contains the pattern of a 3x3 grid
