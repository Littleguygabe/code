                ...
                try:
                    ...
                    for P in self.__AllowedPatterns:
                        ...
                        if P.MatchesPattern(PatternString, CurrentSymbol): #passes in a 9 element long array that contains the pattern of a 3x3 grid
                            ...
                            for x in range(0,3):
                                for y in range(-2,1):
                                    if self.__GetCell(StartRow+x,StartColumn+y).isDouble(): ## remember to add the startrow and startColumn
                                        return 20
                            return 10
                except:
                    pass
...
class DoubleCell(Cell): ## remember to inherit the cell class
    def __init__(self):
        super(DoubleCell,self).__init__() ## look at the class above to copy
        self._Symbol = 'D'
