...
class Puzzle():
    ...
    def SavePuzzle(self):
        ...
        for pattern in self.__AllowedPatterns:
            f.write(pattern.getpatternSymbol()+','+pattern.GetPatternSequence()+'\n')
        ...
        for cell in self.__Grid:
            ...
            if len(cell.getSymbolsNotAllowed())>=1:
                for letter in cell.getSymbolsNotAllowed():
                    f.write(','+letter)
            else:
                f.write(',')
            f.write('\n')
    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            ###
            choice = input('do you want to save your game?(Y/N)').upper()
            if choice == 'Y':
                self.SavePuzzle()
