...
class Puzzle():
    ...
    def deleteSymbol(self):
        ...
        if self.CheckforMatchWithPattern(Row,Column)==0:
            if symbol != '-' and symbol != '@':
                self.__GetCell(Row,Column).ChangeSymbolInCell('')
                ...
                print('Cannot remove from that cell')
    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            valid = False
            while not valid:
                deleteSymbol = str(input('Do you want to delete a symbol from the puzzle? (Y/N) '))
                if deleteSymbol.upper()=='Y' or deleteSymbol.upper()=='N':
                    valid = True

            if deleteSymbol.upper() == 'Y':
                self.deleteSymbol()
            ### End of changes
