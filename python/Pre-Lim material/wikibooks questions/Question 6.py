...
###n
    def getRotatedPatternString(self,patternString,rotation):
        if rotation == 0:
            return patternString

        elif rotation == 1:
            return patternString[2:8]+patternString[0:2]+patternString[8]
        
        elif rotation == 2:
            return patternString[4:8]+patternString[0:4]+patternString[8]
    
        elif rotation == 3:
            return patternString[6:8]+patternString[0:6]+patternString[8]
            ...
            for StartColumn in range(Column - 2, Column + 1):
                try:
                    ...
                    for P in self.__AllowedPatterns:
                        ...
                        ###
                        for i in range(1,4): #0 is normal, 1 is 90 degrees, 2 is 180 degrees, 3 is 270 degrees
                            rotatedPattern = self.getRotatedPatternString(PatternString,i)
                            if P.MatchesPattern(rotatedPattern, CurrentSymbol): #passes in a 9 element long array that contains the pattern of a 3x3 grid
