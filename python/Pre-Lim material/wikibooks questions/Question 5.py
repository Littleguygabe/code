...
class Puzzle():
    ...
    ###
    def savePuzzle(self):
        with open(f'{self.SaveName}.txt','w') as f:
            ...
            for cell in self.__Grid:
                ...
                if symbol != '-':
                    f.write(symbol)
                if len(cell.getNotAllSyms()) == 0:
                    f.write(',\n')
                else:
                    f.write(',')
                    f.write(','.join(cell.getNotAllSyms())+'\n')
    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            ###
            choice = input('Do you want to save your game?(y/n)').lower()
            if choice == 'y':
                if len(self.SaveName) == 0:
                    self.SaveName = input('enter the file name')
                self.savePuzzle()
            Row = -1
            Valid = False
            while not Valid:
